...
News  Feed application
A simple, news feed Application built using HTML, CSS, and JavaScript. This project demonstrates dynamic content rendering without reloading the entire page.


---

🚀 Features
news feed layout with smooth navigation
...
git clone https://github.com/Sharmila907/News feed application.git
